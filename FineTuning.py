...
from utils import AverageMeter, calc_psnr, SSIMLoss, grayscale_ssim


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--train-file', type=str, default="HanokModel/hanokModel.h5")
    parser.add_argument('--eval-file', type=str, default="HanokModel/hanokEval.h5")
    parser.add_argument('--outputs-dir', type=str, default="HanokModel/model")
    ...
    model.load_state_dict(torch.load("best_psnr.pth", map_location=device))
    ...
    for epoch in range(args.num_epochs):
        ...
        with tqdm(total=(len(train_dataset) - len(train_dataset) % args.batch_size)) as t:
            ...
            for data in train_dataloader:
                ...
                if args.loss == "MSE":
                    ...
                    loss = SSIMLoss(preds, labels, device)
        ...
        for data in eval_dataloader:
            ...
            epoch_ssim.update(grayscale_ssim(preds, labels), len(inputs))
